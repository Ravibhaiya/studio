...
export default function Home() {
    ...
    // SVG path for the scalloped circle timer from Android Clock Widget
    const scallopPath = "M 50,0 A 50,50 0 0 1 100,50 A 50,50 0 0 1 50,100 A 50,50 0 0 1 0,50 A 50,50 0 0 1 50,0 Z M 87.5,50 A 37.5,37.5 0 0 0 50,12.5 A 37.5,37.5 0 0 0 12.5,50 A 37.5,37.5 0 0 0 50,87.5 A 37.5,37.5 0 0 0 87.5,50 Z M 95.11,34.19 C 91.56,25.96 85.04,18.44 76.81,14.89 L 71.7,24 C 77.5,26.7 82.3,31.5 85,37.3 L 95.11,34.19 Z M 65.81,4.89 C 59.98,3.2 55.06,2.5 50,2.5 C 44.94,2.5 40.02,3.2 34.19,4.89 L 37.3,15 C 41.5,12.3 45.7,11.16 50,10.88 C 54.3,11.16 58.5,12.3 62.7,15 L 65.81,4.89 Z M 23.19,14.89 C 14.96,18.44 8.44,25.96 4.89,34.19 L 15,37.3 C 17.7,31.5 22.5,26.7 28.3,24 L 23.19,14.89 Z M 4.89,65.81 C 8.44,74.04 14.96,81.56 23.19,85.11 L 28.3,76 C 22.5,73.3 17.7,68.5 15,62.7 L 4.89,65.81 Z M 34.19,95.11 C 40.02,96.8 44.94,97.5 50,97.5 C 55.06,97.5 59.98,96.8 65.81,95.11 L 62.7,85 C 58.5,87.7 54.3,88.84 50,89.12 C 45.7,88.84 41.5,87.7 37.3,85 L 34.19,95.11 Z M 76.81,85.11 C 85.04,81.56 91.56,74.04 95.11,65.81 L 85,62.7 C 82.3,68.5 77.5,73.3 71.7,76 L 76.81,85.11 Z";
